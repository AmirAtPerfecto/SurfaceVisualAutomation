...
public abstract class PerfectoUtils {
	...
	public static void typeText(RemoteWebDriver driver, String cmd) {
		HashMap params = new HashMap();
		params.put("text", String.valueOf(cmd));

		driver.executeScript("mobile:typetext", new Object[]{params});

//		Map<String, String> params = new HashMap<String, String>();
//		params.put("command", cmd);
//
//		driver.executeScript("mobile:typetext", params);
	}
	...
	public static String ocrImageSelect(RemoteWebDriver driver, String img, int threshold, int timeout) {
		Map<String, Object> params = new HashMap<>();
